...
int greathallCardEffect(struct gameState *state, int currentPlayer, int handPos ){
  int i;
  int j;
  int k;
  int x;
...
int outpostCardEffect(struct gameState *state, int currentPlayer, int handPos  ){
  int i;
  int j;
  int k;
  int x;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
  ...
  switch( card )
    ...
    case great_hall:
      return greathallCardEffect(state, currentPlayer, handPos );
    ...
    case outpost:
      return outpostCardEffect(state, currentPlayer, handPos );
